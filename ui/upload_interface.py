...
from rag_system.llama_index_integration import LlamaIndexIntegration
...
def upload_file():
    ...
    client_id = request.form.get('client_id')  # Assuming client_id is provided to distinguish clients
